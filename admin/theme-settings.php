...
$options[] = array( "name" => esc_html__('Logo in Navigation Width','mvp-text'),
			"desc" => "If you are utilizing the Google AMP feature, you will need to enter the width of your navigation logo file here. Default is 200.",
			"id" => $shortname."_amp_logow",
			"std" => "200",
			"type" => "text");
	
$options[] = array( "name" => esc_html__('Logo in Navigation Height','mvp-text'),
			"desc" => "If you are utilizing the Google AMP feature, you will need to enter the height of your navigation logo file here. Default is 50.",
...
$options[] = array( "name" => __('Show Page Views?','mvp-text'),
			"desc" => "Uncheck this box if you would like to remove the number of page views from the images throughout the site.",
			"id" => $shortname."_page_views",
			"std" => "true",
			"type" => "checkbox");
...
$options[] = array( "name" => __('Disqus Forum Shortname','mvp-text'),
			"desc" => "If you want to use Disqus for your comments, enter your Disqus Forum Shortname in order to activate Disqus on your site. This is the unique identifier for your website in Disqus (i.e. yourforumshortname.disqus.com)",
...
/* Google AMP Settings */
$options[] = array( "name" => esc_html__('Google AMP Settings','mvp-text'),
			"type" => "heading");
	
$options[] = array( "name" => esc_html__('Enable Google AMP on mobile devices','mvp-text'),
...
$options[] = array( "name" => esc_html__('Facebook App ID','mvp-text'),
