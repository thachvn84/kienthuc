	...
	var aboveHeight = $('#head-main-top').outerHeight();
	    $(window).scroll(function(){
	    	if ($(window).scrollTop() > aboveHeight){
	    		$('#main-nav-wrap').addClass('fixed').css('bottom','0');
	    		...
	    		$('.col-tabs-wrap').removeClass('fixed-col').css('bottom','0');
