									...
									<div class="foot-widget left relative">
										<?php if(get_option('mvp_logo_footer')) { ?>
											<div class="foot-logo left realtive">
												<img src="<?php echo esc_url(get_option('mvp_logo_footer')); ?>" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" />
											</div><!--foot-logo-->
										<?php } else { ?>
											<div class="foot-logo left realtive">
												<img src="<?php echo get_template_directory_uri(); ?>/images/logos/logo-foot.png" alt="<?php bloginfo( 'name' ); ?>" data-rjs="2" />
											</div><!--foot-logo-->
										<?php } ?>
