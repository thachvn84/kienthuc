<?php
	/* Template Name: Khoahoc */
?>
<?php get_header(); ?>
<h1 class="cat-head left" style="display: none;"><?php single_cat_title(); ?></h1>
				...
				<div class="home-wrap-out2">
					<div id="tab-col2" class="home-mid-col relative tab-col-cont theiaStickySidebar">
						<?php if ( is_active_sidebar( 'archive-left-widget' ) ) { ?>
							<?php dynamic_sidebar( 'archive-left-widget' ); ?>
						<?php } ?>
					</div><!--home-left-col-->
					<div class="home-wrap-in2">
						<div id="tab-col1" class="home-left-col relative tab-col-cont">
							...
							<div id="archive-list-wrap" class="left relative">
                                <?php if( is_tag() ) { ?><h1 class="arch-head"><?php _e( 'Những bài viết về', 'mvp-text' ); ?> "<?php single_tag_title(); ?>"</h1><?php } ?>
